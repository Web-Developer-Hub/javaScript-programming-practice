...
// first of all object sreingfy and ten stringyfy object convert to parse object
const convertStringify = JSON.stringify(products)
console.log(convertStringify);
const convertObject = JSON.parse(convertStringify);
console.log(convertObject);
const { name, color, price, ram, rom, camera, fitures } = convertObject;
...
// // oject destructureing here, this object is my direct object..
