// filter use in array..filter big number in array, filter alwas retur an array..
const number = [34, 23, 12, 13, 16, 19, 37, 38, 44, 10, 32]
const result = number.filter((params) => params > 20);
console.log(result);

// filter use in array..filter small number in array, filter alwas retur an array..
const number2 = [34, 23, 12, 13, 16, 19, 37, 38, 44, 10, 32]
const result2 = number2.filter((params) => params < 20);
console.log(result2);
...
// chipest price array of object find out
const chipPrice = products.filter((params) => params.price < 12000);
console.log(chipPrice);

//rom 64gb product findout...
const phoneRom = products.filter((product) => product.rom === '64gb');
console.log(phoneRom);

// black blue color product findout....
const blackColor = products.filter((product) => product.color === 'black blue');
